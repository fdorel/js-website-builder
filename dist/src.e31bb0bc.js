...
var model = [new _blocks.TitleBlock('Vanilla Javascript Website Builder', {
  tag: 'h2',
  styles: {
    background: '#493240',
    color: '#fff',
  ...
  alt: 'Это картинка'
}), new _blocks.ColumnsBlock(['A simple app made with Javascript, without using any libraries', 'Find out how SOLID principles and OOP programming work', 'Try improving website UI with different styles'], {
  styles: {
    background: '#5e3de3',
    padding: '2rem',
    color: '#fff',
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    key: "template",
    get: function get() {
      return [(0, _utils.block)('TEXT'), (0, _utils.block)('TITLE'), (0, _utils.block)('CONTENT'), (0, _utils.block)('IMAGE')].join('');
    }
  }, {
    key: "add",
